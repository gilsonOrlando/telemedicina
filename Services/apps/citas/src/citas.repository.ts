...
export class CitasRepository extends AbstractRepository<CitaMedica> {
    ...
    constructor(
        ...
        @InjectModel(CitaMedicaPresencial.name) citaMedicaPresencialModel: Model<CitaMedicaPresencial>,
        @InjectModel(CitaMedicaVirtual.name) citaMedicaVirtualModel: Model<CitaMedicaVirtual>,
